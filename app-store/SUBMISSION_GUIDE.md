# App Store Submission Guide — My Digital Crafts
...
3. Fill in:
   - Platform: iOS
   - Name: **My Digital Crafts**
   - Primary Language: English (U.S.)
   - Bundle ID: **com.mydigitalcrafts.app** *(you'll need to register this in your Developer account first)*
...
3. Bundle ID: `com.mydigitalcrafts.app`
...
git remote add origin https://github.com/YOUR_USERNAME/my-digital-closet.git
...
- [ ] In-App Purchase created in App Store Connect (Product ID: `com.mydigitalcrafts.app.premium`)
...
→ Register `com.mydigitalcrafts.app` in your Apple Developer account (Step 3)
