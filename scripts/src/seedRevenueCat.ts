...
const PROJECT_NAME        = "My Digital Crafts";
const APP_STORE_APP_NAME  = "My Digital Crafts";
const APP_STORE_BUNDLE_ID = "com.mydigitalcrafts.app";
...
const PRODUCTS: ProductDef[] = [
  {
    ...
    displayName: "Monthly – My Digital Crafts",
    type:        "subscription",
    duration:    "P1M",
  ...
  },
  {
    ...
    displayName: "Yearly – My Digital Crafts",
    type:        "subscription",
    duration:    "P1Y",
  ...
  },
  {
    ...
    displayName: "Lifetime – My Digital Crafts",
    type:        "non_consumable",
