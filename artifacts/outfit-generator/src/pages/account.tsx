...
export default function AccountPage() {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      flash(
        "success",
        `Restored ${result.clothingAdded} items and ${result.outfitsAdded} collections.` +
      ...
      <div className="flex flex-col gap-4 md:grid md:grid-cols-2 md:items-start">
        ...
        <Card emoji="💾" title="Backup & Restore">
          <p className="text-sm text-black/60 leading-snug">
            Export your crafts to a file. Save it to iCloud Drive or Files to
          ...
          <p className="text-sm font-bold leading-snug" style={{ color: "#C0390B" }}>
            ⚠️ Deleting the app removes all your crafts data.
          ...
          <p className="text-xs text-black/40 text-center leading-snug">
            Importing replaces your current crafts with the backup.
          </p>
        </Card>

        {/* ── 3. APP INFO ─────────────────────────────────────────────────── */}
        <Card emoji="🎨" title="My Digital Crafts">
          <p className="text-sm text-black/55 leading-snug">
            Version 1.0.0
          </p>
          <p className="text-sm text-black/55 leading-snug">
            Your crafts stay on your device, works offline, and can be
