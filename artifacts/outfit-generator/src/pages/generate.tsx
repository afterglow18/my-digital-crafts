/**
 * GeneratePage — "Spin It" screen for My Digital Crafts.
 *
          ...
          <>
            ...
            <div style={{
              ...
              <div style={{
                ...
                fontWeight: 700,
                fontSize: Math.max(16, Math.min(pW(ir, 0.075), ir.containerH * 0.095)),
                color: "#F5F0E8",
                lineHeight: 1.1,
              ...
              <div style={{
                ...
                fontWeight: 900,
                fontSize: Math.max(8, Math.min(pW(ir, 0.032), ir.containerH * 0.026)),
            ...
            {!hasItems && (
              <div style={{
                ...
                <p style={{
                  ...
                  Your crafts collection is empty
                </p>
                <p style={{
