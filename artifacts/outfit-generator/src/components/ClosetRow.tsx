...
const BG_CENTER   = "rgba(245,240,230,0.94)"; // off-white card for selected item
const SHADOW_CTR  = "0 4px 18px rgba(0,0,0,0.18), 0 1px 4px rgba(0,0,0,0.10)";
        ...
        >
          {items.slice(lo, hi + 1).map((item, localIdx) => {
            ...
            if (transitioning) {
              ...
              bg      = `rgba(245,240,230,${(p * 0.94).toFixed(3)})`;
              shadow  = p > 0.05
